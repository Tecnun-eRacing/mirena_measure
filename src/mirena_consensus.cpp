...
#define CONTROL_SUB_TOPIC "control/ackerman_drive"
...
public:
    ...
    MirenaConsensusNode() : Node("mirena_lidar"),
                            ...
                            _control_sub(this->create_subscription<mirena_common::msg::AckermannDriveStamped>(CONTROL_SUB_TOPIC, 10, std::bind(&MirenaConsensusNode::control_callback, this, std::placeholders::_1))),
...
private:
    ...
    void control_callback(const mirena_common::msg::AckermannDriveStamped::SharedPtr msg) { this->_ekf_scheduler.receive_control(msg); }
    ...
    rclcpp::Subscription<mirena_common::msg::AckermannDriveStamped>::SharedPtr _control_sub;
